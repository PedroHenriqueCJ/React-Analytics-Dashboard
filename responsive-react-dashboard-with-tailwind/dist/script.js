...
React.createElement("img", {
  src: "https://media-hosting.imagekit.io//bac46ff144f04f11/Novo%20projeto%2051%20[BFF66C2].png?Expires=1837109184&Key-Pair-Id=K2ZIVPTIP2VGHC&Signature=cukWJgRSo3EPYpDeCi5tchLQsAOPJT2fiMcH9lRmNRFFkKOb9y5CLCy8peXjU5m~A9uKqwgS4NjATpwCmQ9vt9Vk6tihMHQ255wpL4mxpLDRZE6RcjLSB6TGK3D7HqmbqV~pwSbU9BuT339fB2us6yzXUXMeJLq210WirjhDBNjvnW0AsdrEjxjXzUxNGudXaQxhg7DeJuxtRUbHNIbGXjP4LWOpiNqEBEqsNuuuJ3mRRZPXA-~f6BufGTIXsKw3cifooI5T7gpcbvSyilEQxYtWPssOXpV0lf9UnVCGLrqoqBsPtyALvz7-z5hS8XVSbVFNZUqFYSCPQdSDsbJQBw__",
  className: "w-9 h-9",
  alt: "Ícone personalizado"
    ...
    React.createElement("div", { className: "block sm:hidden xl:block ml-2 font-bold " }, "Pedro Henrique C. de Jesus"), /*#__PURE__*/
...
function Content({ onSidebarHide }) {
  return /*#__PURE__*/(
    ...
    React.createElement("div", { className: "text font-bold text-white" }, "Hello, Pedro"), /*#__PURE__*/
    React.createElement("div", { className: "" }, /*#__PURE__*/
    React.createElement(Icon, { path: "" }), /*#__PURE__*/
  ...
  imgId })
{
  ...
  return /*#__PURE__*/(
    ...
    // achei //
    React.createElement("stop", { stopColor: "#026CE0" }), /*#__PURE__*/
    React.createElement("stop", { offset: "1", stopColor: "#026CE0" }))))), /*#2f49d0__PURE__*/
...
function Graph() {
  const CustomTooltip = ({ active, payload }) => {
    if (active && payload && payload.length) {
      return /*#__PURE__*/(
        ...
        React.createElement("div", { className: "text-white font-bold" }, `$${payload[0].value.toFixed(2)}`), /*#__PURE__*/
        React.createElement("div", { className: "" }, payload[0].payload.name)))
      );
    }
    return null;
  };
  ...
  return /*#__PURE__*/(
    ...
    React.createElement(LineChart, { data: graphData }, /*#__PURE__*/
    React.createElement("defs", null, /*#__PURE__*/
    React.createElement("linearGradient", { id: "paint0_linear", x1: "0", y1: "0", x2: "1", y2: "0" }, /*#__PURE__*/
    ...
    React.createElement("linearGradient", { id: "shadowGradient", x1: "0", y1: "0", x2: "0", y2: "1" }, /*#__PURE__*/
    React.createElement("stop", { offset: "0%", stopColor: "#6B8DE3", stopOpacity: "0.3" }), /*#__PURE__*/
    React.createElement("stop", { offset: "100%", stopColor: "#7D1C8D", stopOpacity: "0.1" }))), /*#__PURE__*/
    ...
    React.createElement(Tooltip, { content: /*#__PURE__*/React.createElement(CustomTooltip, null) }), /*#__PURE__*/
    
    /* Área da sombra - DEVE vir antes das linhas */
